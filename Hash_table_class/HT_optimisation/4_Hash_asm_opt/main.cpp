...
int main ()
{
	//printf("Genoa hash = %u std = %u\n", MurmurHash ("Genoa"), MurmurHash_std ("Genoa"));
	//printf("and hash = %u std = %u\n", MurmurHash ("and"), MurmurHash_std ("and"));
	//printf("started hash = %u std = %u\n", MurmurHash ("started"), MurmurHash_std ("started"));
